#!/bin/bash
# Run script for foxglove_gstreamvideo_app
...
BINARY="./build/apps/cxx11/foxglove_gstreamvideo_app/foxglove_gstreamvideo_app"
if [ ! -f "$BINARY" ]; then
...
echo "========================================"
echo "Running: foxglove_gstreamvideo_app"
echo "========================================"
