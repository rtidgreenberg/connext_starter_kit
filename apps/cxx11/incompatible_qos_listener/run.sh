#!/bin/bash
# Run script for incompatible_qos_listener
...
BINARY="./build/apps/cxx11/incompatible_qos_listener/incompatible_qos_listener"
if [ ! -f "$BINARY" ]; then
...
echo "========================================"
echo "Running: incompatible_qos_listener"
echo "========================================"
