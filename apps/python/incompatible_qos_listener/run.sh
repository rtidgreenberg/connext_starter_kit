#!/bin/bash
# Run script for Incompatible QoS Listener Application (Python).
...
echo "=== Incompatible QoS Listener Application (Python) ==="
echo
python_env_init "incompatible_qos_listener" "$REPO_ROOT"
...
# --- Run Application ---
echo
echo "Starting Incompatible QoS Listener Application..."
echo "------------------------------------------"
cd "$SCRIPT_DIR"
python incompatible_qos_listener.py "$@"
